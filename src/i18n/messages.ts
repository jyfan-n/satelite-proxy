...
const en = {
  ...
  "chain.title": "Chain",
  "chain.desc":
    "Define reusable node pools and multi-hop chains (sing-box detour), then route a rule through one.",
  "chain.poolsHeading": "Node pools",
  "chain.chainsHeading": "Chains",
  ...
  "chain.editorHint":
    "Drag a node/pool from the left onto the canvas, then drag a connection between hops (left → right = client → internet). The chain must form a single straight line.",
  "chain.dragHint": "Drag onto the canvas",
...
const zh: Record<MessageKey, string> = {
  ...
  "settings.hintChain": "节点池 · 多跳链路（sing-box detour）",
  ...
  "rules.targetChain": "链路",
  "rules.pickNode": "节点",
  "rules.pickNodePh": "搜索节点名…",
  "rules.needNode": "请选择一个节点",
  "rules.pickChain": "链路",
  "rules.needChain": "请选择一个链路",
  "rules.noChains": "暂无链路，请先在链路页面创建",
  "rules.chainStaleHint": "指定链路已不存在（已删除）。当前回退到 PROXY，请重新选择。",
  ...
  // chain
  "chain.title": "链路",
  "chain.desc": "定义可复用的节点池和多跳链路（sing-box detour），然后让规则走某条链路。",
  "chain.poolsHeading": "节点池",
  "chain.chainsHeading": "链路",
  "chain.newPool": "新建节点池",
  ...
  "chain.confirmDeletePool": "删除节点池「{name}」？请先处理引用它的链路。",
  "chain.newChain": "新建链路",
  "chain.editChain": "编辑链路",
  "chain.chainName": "链路名称",
  ...
  "chain.editorHint":
    "从左侧把节点/节点池拖到画布上，然后在各跳之间拖拽连线（从左到右 = 客户端 → 互联网）。链路必须是一条直线。",
  "chain.dragHint": "拖拽到画布上",
  "chain.needChainName": "请填写链路名称",
  "chain.needLinearChain": "链路必须是一条直线——不能有分支、环路或孤立的跳。",
  "chain.needAtLeastTwoHops": "链路至少需要 2 跳——单跳等同于直接指定节点/节点池。",
  "chain.noChainsYet": "暂无链路。",
  "chain.confirmDeleteChain": "删除链路「{name}」？引用它的规则会回退到 PROXY。",
};
