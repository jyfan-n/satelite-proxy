...
const zh: Record<MessageKey, string> = {
  ...
  "chain.editorHint":
    "将左侧节点/节点池拖到画布上，或直接点击追加到链路末尾。拖动圆点在跳之间连线（从左到右 = 客户端 → 互联网），链路必须是一条直线。选中后按 Delete 可移除。",
  ...
  "chain.diag": "诊断",
  "chain.diagTitle": "链路诊断 · {name}",
  "chain.diagHop": "跳",
  "chain.diagSolo": "单跳",
  "chain.diagChained": "链路至此",
  "chain.diagExit": "出口",
  ...
  "chain.diagHint":
    "「单跳」= 该跳单独出网延迟；「链路至此」= 经完整链前缀到该跳出网的延迟，末行即整链。单跳 ✓ 但链路 ✗ 即可定位断在被中转进入的那一跳（通常是入口优化节点拒绝境外来源）。真实探测（ip.sb 延迟 + 出口归属地/IP 质量信息）走应用内置的回环诊断入口，无需配置任何规则。",
  "chain.hopsCount": "{n} 跳",
  "chain.usedByRuleSets": "被 {n} 个规则集引用",
  "chain.notUsedByRules": "未被规则集引用",
  "chain.usedByChains": "被 {n} 条链路引用",
